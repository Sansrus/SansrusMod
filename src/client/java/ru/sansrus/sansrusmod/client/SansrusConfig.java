...
import ru.sansrus.sansrusmod.client.config.ColorPickerControllerBuilder;
...
public class SansrusConfig {
    ...
    public boolean deathWaypoint        = false;
    public int rmbCooldownThreshold     = 20;
    ...
    public boolean mapSlotPreview       = false;
    public boolean matchingSlotHighlight= false;
    public boolean chatMessageCounter   = false;
    ...
    public Screen createScreen(Screen parent) {
        ...
        Option<Integer> optRmbCooldownThreshold = Option.<Integer>createBuilder()
                .name(Component.translatable("sansrusmod.config.rmbCooldownThreshold"))
                .description(OptionDescription.of(Component.translatable("sansrusmod.config.rmbCooldownThreshold.tooltip")))
                .binding(20, () -> rmbCooldownThreshold, v -> rmbCooldownThreshold = v)
                .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                        .range(0, 100)
                        .step(1)
                        .formatValue(val -> {
                            if (val == 0) return Component.translatable("sansrusmod.config.rmbCooldownThreshold.immediately");
                            return Component.literal(val + " ticks");
                        }))
                .build();
        ...
        Option<Integer> optBookScrollSpeed = Option.<Integer>createBuilder()
                .name(Component.translatable("sansrusmod.config.bookScrollSpeed"))
                .description(OptionDescription.of(Component.translatable("sansrusmod.config.bookScrollSpeed.tooltip")))
        ...
        Option<Integer> optHighlightColor = Option.<Integer>createBuilder()
                .name(Component.translatable("sansrusmod.config.highlightColor"))
                .description(OptionDescription.of(Component.translatable("sansrusmod.config.highlightColor.tooltip")))
                .binding(0x6000FF00, () -> highlightColor, v -> highlightColor = v)
                .controller(ColorPickerControllerBuilder::create)
                .build();
        ...
        Option<Integer> optArmorBarDisplay = Option.<Integer>createBuilder()
                .name(Component.translatable("sansrusmod.config.armorbarDisplay"))
                .description(OptionDescription.of(Component.translatable("sansrusmod.config.armorbarDisplay.tooltip")))
                .binding(21, () -> armorbarDisplay, v -> armorbarDisplay = v)
                .controller(opt -> IntegerSliderControllerBuilder.create(opt)
                        .range(0, 21)
                        .step(1)
                        .formatValue(val -> {
                            if (val == 0) return Component.translatable("sansrusmod.config.armorbarDisplay.off");
                            if (val == 21) return Component.translatable("sansrusmod.config.armorbarDisplay.always");
                            return Component.translatable("sansrusmod.config.armorbarDisplay.seconds", val);
                        }))
                .build();
        ...
        Option<Boolean> optMapSlotPreview = bool(
                ...
                "sansrusmod.config.mapSlotPreview.tooltip",
                false, () -> mapSlotPreview, v -> mapSlotPreview = v);

        ConfigCategory.Builder mainCategoryBuilder = ConfigCategory.createBuilder()
                .name(Component.translatable("sansrusmod.config.category.main"))
                .tooltip(Component.translatable("sansrusmod.config.category.main.tooltip"));
        ...
        mainCategoryBuilder
                .option(optRmbCooldownThreshold)
                ...
                .option(optMapSlotPreview)
                .option(optHightLight)
                .option(optHighlightColor)
